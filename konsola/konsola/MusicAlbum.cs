namespace konsola
{
    public class MusicAlbum(string artist, string album, uint songsNumber, int yearOfEdition, uint downloadNumber)
    {
        ...
        private readonly string album = album;
        private readonly uint songsNumber = songsNumber;
        private readonly int yearOfEdition = yearOfEdition;
        private readonly uint downloadNumber = downloadNumber;
